# Análisis Exploratorio de Datos: Impacto del Consumo de Café en la Salud y Estilo de Vida
...
## 📦 Datasets usada
**Global Coffee Health Dataset** | Kaggle | ([link](https://www.kaggle.com/datasets/uom190346a/global-coffee-health-dataset/data))
...
2. **Añadidas las columnas necesarias**
3. **Análisis general del los datos**
4. **Análisis de los Hipótesis**
